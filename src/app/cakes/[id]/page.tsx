"use client";
import { CakesList } from "@/components/Cakes/Cakes";
...
const page = ({ params }: { params: { id: number } }) => {
  const item = CakesList[params.id - 1];

  return (
    <div>
      <div className="flex justify-center">
        <Link className="text-center p-3 border rounded-lg mt-10" href="/cakes">
          Back
        </Link>
      </div>
      <div className="sm:flex gap-x-5 justify-center">
        <div className="mx-auto mt-6 w-[865px] sm:mt-0 p-2 border hover:shadow-lg">
          ...
          <p className="text-2xl font-bold underline">About this Cakes :</p>
